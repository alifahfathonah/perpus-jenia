		...
		while($d = mysqli_fetch_array($data)){
			...
			<tr>
				...
				<td><?php echo $d['status_aktif']; ?></td>
					...
					<td><a href="edit_anggota.php?id=<?php echo $d['id']; ?>"><span class="glyphicon glyphicon-edit"></span></a>
					   <a href="hapus_anggota.php?id=<?php echo $d['id']; ?>"onclick="return confirm('Data akan di hapus?');""><span class="glyphicon glyphicon-trash"></span></a>
				</td>
			</tr>
			<?php 
		}
