...
<body id="page-top">
 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
	...
	<a href="penerbit.php"><button type="button" class="btn btn-warning">Kembali</button></a><br><br>
	<?php
	include 'connect.php';
	$id = $_GET['id'];
	...
	<br/>
	<br/>
	<form action="editaksi_penerbit.php" method="post">
  ...
  <div class="row">
  	<div class="col">
  	<input type="text" class="form-control" name="email" placeholder="email" value="<?php echo $d['email'];?>">
  </div>
  <div class="col">
  	<input type="text" class="form-control" name="telepon" placeholder="telepon" value="<?php echo $d['telepon'];?>">
