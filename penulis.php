...
<body id="page-top">
	...
	<br/>
	<a href="tambah_penulis.php"><button type="button" class="btn btn-warning">tambah penulis</button></a>
	...
	<table class="table table-hover" style="width: 3000px;" >
		...
		while($d = mysqli_fetch_array($data)){
			...
			<tr>
				...
				<td>
					<a href="edit_penulis.php?id=<?php echo $d['id']; ?>"><span class="glyphicon glyphicon-edit"></span></a>
					<a href="hapus_penulis.php?id=<?php echo $d['id']; ?>" onclick="return confirm('Data akan di hapus?');"><span class="glyphicon glyphicon-trash"></a>
				</td>
			</tr>
			<?php 
		}
